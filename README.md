...
### Submission Notes
- After running, capture the console output which should show the "School Directory" section (demonstrating polymorphic dispatch) and the "Attendance Records" section with richer displays.
- Commit changes to a new branch `part-07`, push, and open a PR from `part-07` into `part-06`.
